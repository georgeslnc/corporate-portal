...
export default function Application() {
  ...
  const [selectedDepartment, setSelectedDepartment] = useState<string | null>('0');
      ...
      {titleGroup && (
        <>
          <Typography variant="h5" component="h2" sx={{ marginTop: '50px' }}>
            Коротко укажите вашу проблему и желаемое время на устрание(минимум 1 час)
          </Typography>
          <Typography variant="h6" component="h2" sx={{ fontSize: '14px' }}>
            Если ваша заявка требует неотложна зайдите в справочник и свяжитесь на прямую
          </Typography>
          <Box
            sx={{
              width: 400,
